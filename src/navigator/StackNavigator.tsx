...
export const  StackNavigator = () => {
    return (
        <Stack.Navigator
            //initialRouteName='Pagina2Screen' //Sirve para decirle desde cual pagina queremos comenzar al abrir la app 
            screenOptions={{
                headerStyle:{
                    elevation: 0, //quitarle la linea del header en android
                    shadowColor: 'transparent', //quitarle la linea del header en ios
                },
                cardStyle:{
